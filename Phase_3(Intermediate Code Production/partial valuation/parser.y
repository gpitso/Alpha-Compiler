...
expr:        assignexpr {$$ = $1;}             
            ...
            | expr {tmpquad=currQuad;} GREATER expr	{
							        ...
							        emit(if_greater, $1, $4, NULL, currQuad + 3, currQuad);
            ...
            | expr GREATER_OR_EQUAL {tmpquad=currQuad;} expr {
                                 SymbolTableEntry *tmp = newtemp(LOKAL);
                                    expr* tmpexpr = lvalue_expr(tmp);
							        tmpexpr->truelist=(backpatch*)make_tlist(nextquadlabel()+2);
                                    tmpexpr->falselist=(backpatch*)make_flist(nextquadlabel() + 1);
            ...
            | expr LESS{tmpquad=currQuad;} expr {
            ...
            | expr LESS_OR_EQUAL{tmpquad=currQuad;} expr {
            ...
            | expr EQUALS {tmpquad=currQuad;}expr {
                                    SymbolTableEntry *tmp = newtemp(LOKAL);
                                    expr* tmpexpr = lvalue_expr(tmp);
							        tmpexpr->truelist=(backpatch*)make_tlist(nextquadlabel()+2);
                                    tmpexpr->falselist=(backpatch*)make_flist(nextquadlabel() + 1);
            ...
            | expr NOT_EQUALS {tmpquad=currQuad;}expr {
                                    SymbolTableEntry *tmp = newtemp(LOKAL);
                                    expr* tmpexpr = lvalue_expr(tmp);
							        tmpexpr->truelist=(backpatch*)make_tlist(nextquadlabel()+2);
                                    tmpexpr->falselist=(backpatch*)make_flist(nextquadlabel() + 1);
            ...
            | expr AND M expr {
                                ...
                                backpatchh($1->falselist, tmpquad);
                                $1->truelist = $4->truelist;
                                $1->falselist = mergeList($1->falselist, $4->falselist);
            ...
            | expr OR M expr {
                                ...
                                backpatchh($1->truelist, $4->truelist->quadadd);
                                $1->truelist = mergeList($1->truelist, $4->truelist);
                                

                                $1->falselist = $1->falselist;
